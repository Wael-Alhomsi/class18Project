...
DELIMITER //
  CREATE TRIGGER InsertFieldsLocationNotNull1 BEFORE
  INSERT ON
  houses
  FOR
  EACH
  ...
  BEGIN
    ...
    SET MESSAGE_TEXT
    = 'either \'location_address\' or \'location_coordinates_lat\' and \'location_coordinates_lng\' is required';
  END
  IF;
END//

  CREATE TRIGGER InsertFieldsLocationNotNull2 BEFORE
  INSERT ON
  houses
  FOR
  EACH
...
END//
  ...
  CREATE TRIGGER InsertFieldsLocationNotNull3 BEFORE
  INSERT ON
  houses
  FOR
  EACH
